/*
 * PositionForceControl.hpp
 *
 *  Created on: Oct 27, 2011
 *      Author: mriedel
 */

#ifndef POSITIONFORCECONTROL_HPP_
#define POSITIONFORCECONTROL_HPP_
...
class PositionForceControlOptions : public OptionContainer {
public:
...
//	Option<bool>* tPubCommandedAcc;
	...
	PositionForceControlOptions();
};

class PositionForceControl {
private:
	PositionForceControlOptions options;
...
public:
	...
	PositionForceControl();
	virtual ~PositionForceControl();
