#ifndef TRO_ROMPC_HPP
#define TRO_ROMPC_HPP

#include <telekyb_defines/telekyb_defines.hpp>
#include <telekyb_base/Options.hpp>
#include <telekyb_base/Time.hpp>

#include "TRO_RoMPC_Defines.hpp"
...
class RoMPCOptions : public OptionContainer {
public:
...
public:
    ...
    void run_pos(const TKTrajectory& input, const TKState& currentState, const double mass, RoMPCOutput& output, const sensor_msgs::Imu& unbiasedImu, const geometry_msgs::Vector3Stamped& force_estimate);


    void run_att(const Vector3D desired_force, const TKTrajectory& input, const TKState& currentState, RoMPCOutput& output, const sensor_msgs::Imu& unbiasedImu, const geometry_msgs::Vector3Stamped& torque_estimate);
};
