/* Produced by CVXGEN, 2015-09-03 12:05:50 -0400.  */
...
void setup_pointers(void) {
  ...
  vars.x_12 = work.x + 114;
  vars.x_13 = work.x + 120;
  vars.x_14 = work.x + 126;
  vars.x_15 = work.x + 132;
  vars.x_16 = work.x + 138;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 144;
  ds_aff = work.lhs_aff + 144;
  dz_aff = work.lhs_aff + 432;
  mu = 0;
  for (i = 0; i < 288; i++)
