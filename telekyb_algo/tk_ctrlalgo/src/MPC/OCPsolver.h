...
public:
    ...
    Eigen::Matrix3d OCPsolDesigner(double deltaT, Eigen::Vector3d ExternalForce, Eigen::Vector3d CurPosition, Eigen::Vector3d CurVelocity, Eigen::Matrix<double, 3, 16> ReferencePath, Eigen::Vector3d Waypoint, Eigen::Matrix3d CostFunction);
