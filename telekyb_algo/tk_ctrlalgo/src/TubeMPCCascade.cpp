...
// Options
TubeMPCControlOptions::TubeMPCControlOptions()
    : OptionContainer("TubeMPCControl")
{
...
void TubeMPCControl::run_pos(const TKTrajectory& input, const TKState& currentState, const double mass, TubeMPCCtrlOutput& output, const sensor_msgs::Imu& unbiasedImu)
{
...
//        std::cout << "**** Debug 6 ****  " << std::endl;
   ...
   //          std::cout << "**** fly over at ****  " << sub_terminal(2) << " m------" << std::endl;
    ...
    // NOMINAL MPC for the 3D translational motion control
        ...
        Eigen::Matrix<double, 3, 16> ref_path = Eigen::Matrix<double, 3, 16>::Zero();
...
void TubeMPCControl::run_att(const Vector3D desired_force, const TKTrajectory& input, const TKState& currentState, TubeMPCCtrlOutput& output, const sensor_msgs::Imu& unbiasedImu)
{
