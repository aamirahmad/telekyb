/*
 * SmoothLinearFlyTo.hpp
 *
 *  Created on: Nov 22, 2011
 *      Author: mriedel
 */

#ifndef SMOOTHLINEARFLYTO_HPP_
#define SMOOTHLINEARFLYTO_HPP_
...
class SmoothLinearFlyTo : public Behavior {
protected:
	Option<Position3D>* tSmoothLinearFlyToDestination;
	Option<double>* tSmoothLinearFlyToVelocity;
	Option<double>* tSmoothLinearFlyToAcceleration;
	Option<double>* tSmoothLinearFlyToTime;
	Option<double>* tSmoothLinearFlyToDestinationRadius;
