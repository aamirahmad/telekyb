/* Produced by CVXGEN, 2015-10-30 12:47:10 -0400.  */
...
void setup_pointers(void) {
  ...
  vars.x_8 = work.x + 105;
  vars.x_9 = work.x + 111;
  vars.x_10 = work.x + 117;
  vars.x_11 = work.x + 123;
  vars.x_12 = work.x + 129;
  vars.x_13 = work.x + 135;
  vars.x_14 = work.x + 141;
  vars.x_15 = work.x + 147;
  vars.x_16 = work.x + 153;
  vars.x_17 = work.x + 159;
  vars.x_18 = work.x + 165;
  vars.x_19 = work.x + 171;
  vars.x_20 = work.x + 177;
  vars.x_21 = work.x + 183;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 189;
  ds_aff = work.lhs_aff + 189;
  dz_aff = work.lhs_aff + 567;
  mu = 0;
  for (i = 0; i < 378; i++)
