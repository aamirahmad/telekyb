...
Eigen::Matrix3d OCPSolver::OCPsolDesigner(double deltaT, Eigen::Vector3d ExternalForce, Eigen::Vector3d CurPosition, Eigen::Vector3d CurVelocity, Eigen::Matrix<double, 3, 21> ReferencePath, Eigen::Vector3d Waypoint, Eigen::Matrix3d CostFunction)
{
...
void OCPSolver::load_data(double deltaT, Eigen::Vector3d ExternalForce, Eigen::Matrix<double, 6, 1> InitialState, Eigen::Matrix<double, 6, 1> TerminalState, Eigen::Matrix<double, 3, 21> ReferencePath, Eigen::Matrix<double, 6, 2> StateConstraint, Eigen::Matrix<double, 3, 2> InputConstraint, Eigen::Matrix3d CostFunction)
{
    ...
    params.L_term[5] = CostFunction(1,2);
    ...
    params.xr_16[1] = 0;
    params.xr_16[2] = ReferencePath(1,16);
    params.xr_16[3] = 0;
    params.xr_16[4] = ReferencePath(2,16);
    params.xr_16[5] = 0;

    params.xr_17[0] = ReferencePath(0,17);
    params.xr_17[1] = 0;
    params.xr_17[2] = ReferencePath(1,17);
    params.xr_17[3] = 0;
    params.xr_17[4] = ReferencePath(2,17);
    params.xr_17[5] = 0;

    params.xr_18[0] = ReferencePath(0,18);
    params.xr_18[1] = 0;
    params.xr_18[2] = ReferencePath(1,18);
    params.xr_18[3] = 0;
    params.xr_18[4] = ReferencePath(2,18);
    params.xr_18[5] = 0;

    params.xr_19[0] = ReferencePath(0,19);
    params.xr_19[1] = 0;
    params.xr_19[2] = ReferencePath(1,19);
    params.xr_19[3] = 0;
    params.xr_19[4] = ReferencePath(2,19);
    params.xr_19[5] = 0;

    params.xr_20[0] = ReferencePath(0,20);
    params.xr_20[1] = 0;
    params.xr_20[2] = ReferencePath(1,20);
    params.xr_20[3] = 0;
    params.xr_20[4] = ReferencePath(2,20);
    params.xr_20[5] = 0;
