/*
 * OmegaNHFCTrajectoryTracker.hpp
 *
 *  Created on: Jun 8, 2012
 *      Author: rspica
 */

#ifndef OMEGANHFCTRAJECTORYTRACKER_HPP_
#define OMEGANHFCTRAJECTORYTRACKER_HPP_
...
class OmegaNHFCTrajectoryTrackerOptions : public OptionContainer {
public:
	...
	OmegaNHFCTrajectoryTrackerOptions();
};

class OmegaNHFCTrajectoryTracker : public TrajectoryTracker {
private:
	OmegaNHFCTrajectoryTrackerOptions options;
...
public:
	...
	OmegaNHFCTrajectoryTracker();
	virtual ~OmegaNHFCTrajectoryTracker();
...
#endif /* OmegaNHFCTRAJECTORYTRACKER_HPP_ */
