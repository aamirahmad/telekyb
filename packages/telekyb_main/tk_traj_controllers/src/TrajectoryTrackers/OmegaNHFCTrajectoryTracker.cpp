/*
 * OmegaNHFCTrajectoryTracker.cpp
 *
...
#include "OmegaNHFCTrajectoryTracker.hpp"
...
PLUGINLIB_EXPORT_CLASS( trajectory_trackers_plugin::OmegaNHFCTrajectoryTracker, TELEKYB_NAMESPACE::TrajectoryTracker);

namespace trajectory_trackers_plugin {

// Options
OmegaNHFCTrajectoryTrackerOptions::OmegaNHFCTrajectoryTrackerOptions()
	: OptionContainer("OmegaNHFCTrajectoryTracker")
{
...
OmegaNHFCTrajectoryTracker::OmegaNHFCTrajectoryTracker()
...
void OmegaNHFCTrajectoryTracker::initialize()
{
...
void OmegaNHFCTrajectoryTracker::destroy(){
}

std::string OmegaNHFCTrajectoryTracker::getName() const{
	return "OmegaNHFCTrajectoryTracker";
}

void OmegaNHFCTrajectoryTracker::trajectoryCB(const TKTrajectory& trajectory){
	boost::mutex::scoped_lock refTrajectoryLock(refTrajectoryMutex);
	refTrajectory = trajectory;
}

void OmegaNHFCTrajectoryTracker::stateCB(const TKState& state){
...
void OmegaNHFCTrajectoryTracker::run(const TKTrajectory& input, const TKState& currentState, const double mass, const Eigen::Matrix3d& inertia, Eigen::Vector4d& ctrlInputs){
...
void OmegaNHFCTrajectoryTracker::saturateUniform(Eigen::Vector4d& ctrlInputs, double mass){
