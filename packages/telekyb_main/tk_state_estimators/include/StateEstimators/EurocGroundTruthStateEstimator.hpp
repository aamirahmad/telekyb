/*
 * EurocGroundTruthStateEstimator.hpp
 *
...
class EurocGroundTruthStateEstimatorOptions : public OptionContainer {
public:
	Option<std::string>* tEurocGroundTruthSeTopicName;
	Option<Eigen::Matrix3d>* tEurocGroundTruthToNEDMatrix;

	// Velocity Filters
	Option<double>* tEurocGroundTruthVelFilterFreq;
	Option<double>* tEurocGroundTruthSmoothVelFilterFreq;
	Option<double>* tEurocGroundTruthAngFilterFreq;

	Option<double>* tEurocGroundTruthSampleTime;

	Option<bool>* tEurocGroundTruthPublishSmoothVel;
    Option<bool>* tEurocGroundTruthUseFrame_id;
    Option<std::string>* tEurocGroundTruthFrame_id;

	EurocGroundTruthStateEstimatorOptions();
};

class EurocGroundTruthStateEstimator : public TELEKYB_NAMESPACE::StateEstimator {
protected:
  ...
  bool busy;
	...
	EurocGroundTruthStateEstimatorOptions options;
