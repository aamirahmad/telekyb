/*
 * EurocStateEstimator.hpp
 *
 *  Created on: Dec 6, 2011
 *      Author: mriedel
 */

#ifndef EUROCSTATEESTIMATOR_HPP_
#define EUROCSTATEESTIMATOR_HPP_
...
class EurocStateEstimatorOptions : public OptionContainer {
public:
	Option<std::string>* tEurocStateEstimatorSeTopicName;
	Option<Eigen::Matrix3d>* tEurocStateEstimatorToNEDMatrix;

	// Velocity Filters
	Option<double>* tEurocStateEstimatorVelFilterFreq;
	Option<double>* tEurocStateEstimatorSmoothVelFilterFreq;
	Option<double>* tEurocStateEstimatorAngFilterFreq;

	Option<double>* tEurocStateEstimatorSampleTime;

	Option<bool>* tEurocStateEstimatorPublishSmoothVel;

	EurocStateEstimatorOptions();
};

class EurocStateEstimator : public TELEKYB_NAMESPACE::StateEstimator {
protected:
  ...
  bool busy;
	...
	EurocStateEstimatorOptions options;
