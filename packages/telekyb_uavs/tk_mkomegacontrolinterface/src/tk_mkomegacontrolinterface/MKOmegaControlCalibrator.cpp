...
MKOmegaControlCalibratorOptions::MKOmegaControlCalibratorOptions()
	: OptionContainer("MKOmegaControlCalibrator")
{
...
MKOmegaControlCalibrator::MKOmegaControlCalibrator(MKOmegaControlInterfaceConnection* connection_)
{

}

MKOmegaControlCalibrator::~MKOmegaControlCalibrator()
{
 // not needed
}

// blocking DriftEstim
// bool MKOmegaControlCalibrator::doGyroDriftEstim()
// {
...
// void MKOmegaControlCalibrator::dataValueUpdated(MKValue* value)
// {
