...
class FixedPointHover : public Behavior {
protected:
	// Option
	Option<double>* tFixedPointHoverMaxInitialVelocity;
	Option<bool>* tFixedPointHoverVelocityMode;
	Option<Position3D>* tFixedPointHoverHoveringPosition;
    Option<double>* tFixedPointHoverHoveringOrientation ;
