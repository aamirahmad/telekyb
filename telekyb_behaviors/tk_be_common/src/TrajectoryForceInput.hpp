/*
 * TrajectoryForceInput.hpp
 *
 *  Created on: Mar 2, 2012
 *      Author: mriedel
 */

#ifndef TRAJECTORYFORCEINPUT_HPP_
#define TRAJECTORYFORCEINPUT_HPP_
...
class TrajectoryForceInput : public Behavior {
protected:
	...
	// CB
	void trajectoryCB(const geometry_msgs::PoseWithCovariance::ConstPtr& msg);

public:
	TrajectoryForceInput();
	virtual ~TrajectoryForceInput();
