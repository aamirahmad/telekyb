/*
 * PositionForceTrajectoryTracker.cpp
 *
 *  Created on: Nov 8, 2011
 *      Author: mriedel
 */

#include "PositionForceTrajectoryTracker.hpp"
...
PLUGINLIB_EXPORT_CLASS( trajectory_trackers_plugin::PositionForceTrajectoryTracker, TELEKYB_NAMESPACE::TrajectoryTracker);

namespace trajectory_trackers_plugin {


// Options
PositionForceTrajectoryTrackerOptions::PositionForceTrajectoryTrackerOptions()
	: OptionContainer("PositionForceTrajectoryTracker")
{
...
PositionForceTrajectoryTracker::PositionForceTrajectoryTracker()
...
void PositionForceTrajectoryTracker::initialize()
{
	...
	//tTcStateSub = nodeHandle.subscribe(tkStateTopicName,1,&PositionForceTrajectoryTracker::tkStateCB, this);
	positionControl = new TELEKYB_NAMESPACE::PositionForceControl;
	...
	// sanity check
//	TrajectoryTracker *tracker = new PositionForceTrajectoryTracker();
//	delete tracker;
}
//	virtual void willBecomeActive() = 0;
//	virtual void willBecomeInActive() = 0;
void PositionForceTrajectoryTracker::destroy()
{

}

std::string PositionForceTrajectoryTracker::getName() const
{
	return "PositionForceTrajectoryTracker";
}


void PositionForceTrajectoryTracker::trajectoryCB(const TELEKYB_NAMESPACE::TKTrajectory& trajectory)
{
	boost::mutex::scoped_lock currentInputLock(currentInputMutex);
	currentInput = trajectory;
}

void PositionForceTrajectoryTracker::stateCB(const TELEKYB_NAMESPACE::TKState& state)
{
