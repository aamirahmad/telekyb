	...
	: OptionContainer("ObstacleProviderController")
{
	...
	tNewObsPubTopicName = addOption<std::string>("tNewObsPubTopicName", "Topic Name of New (which is in standard rostopic format but is the same as tObsPubTopicName) Obstacle Points",
			"NewObstaclePoints", false, true);
